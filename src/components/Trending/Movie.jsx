...
function Movie({ handlerVideoInput, activeElement,handlerNavClose}) {
...
const videosongs = trendingData?.filter(item => item.type.includes("tv show")|| item.type.includes("movie"));
console.log("tvand movie", videosongs);
useEffect(()=>{
  handlerNavClose();
},[])
  return (
